...
/**
 * SSE4.1 EMA update implementation.
 * See the scalar implementation for reference.
 */

class SimilarityEmaFunctions_SSE41
{
public:
  // SSE4.1 EMA update + top-2 min-index search (8 values per iteration).
  // Preconditions:
  //   - ema_buf1, ema_buf2: 16-byte aligned, length >= count
  ...
  static void update_and_find(
    ...
    const size_t count,           // number of distances; multiple of 8
